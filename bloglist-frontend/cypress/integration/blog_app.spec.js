describe('Note ', function() {
  ...
  describe('When a blog exists', function() {
    ...
    it('creator can remove it', function() {
      ...
      // We can test if an element doesn't exist
  ...
  describe('are ordered by likes', function() {
    it('worx', () => {
      ...
      // Assign an alias called `like_a` for later use. We can reference the alias later within a cy.get() or cy.wait() command with an @ prefix.
